...
<html>
  <head>
		...
		<nav>
			<div class="nav-wrapper red">
				...
				<ul id="nav-mobile" class="right hide-on-med-and-down">
					...
					<li><a><i class="material-icons" autofocus>search</i></a></li>
	...
	<section>
		...
		//mongoimport -h ds019482.mlab.com:19482 -d pokemon -c Pokedex -u root -p root --file C:\script.json

		if (isset($_GET['search'])) {

			$q = $_GET['search'];
			$filter = array('nombre' => new MongoRegex("/$q/i"));
			$cursor = $coleccion->find($filter);
	...
	<section>
		<div id="modal1" class="modal">
			...
			<div class="modal-footer">
				<a class="modal-action modal-close waves-effect waves-green btn-flat" href="" id="confirm">Eliminar</a>
